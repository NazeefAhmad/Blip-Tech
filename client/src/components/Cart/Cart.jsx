      ...
      <section className="lg:px-20">
        ...
        <div className="flex flex-col-reverse justify-between lg:flex-row">
          ...
          <div className=" mb-8 w-[100%] h-fit bg-[rgba(0,0,0,0.2)] top-[2%] z-10 px-4 py-6 lg:w-[40%] lg:sticky lg:mb-0">
            ...
            <div className="text-center">
              <button
                onClick={handleProceedToCheckout} // Handle checkout button click
                className="block w-[100%] bg-blue-800 px-2 py-3 text-sm custom-shadow hover:bg-blue-700 active:bg-blue-800 transition ease-in-out duration-500"
              >
                Proceed to Checkout
              </button>
            </div>
        ...
        <div className="w-[100%] flex justify-between mt-8 lg:w-[55%]">
          <NavLink to="/" onClick={() => window.scrollTo(0, 0)}>
            <button className="bg-gray-900 text-sm px-3 py-2 transition ease-in-out duration-500 hover:bg-gray-700">
              {cart.length === 0 ? "Browse Games" : "Continue Shopping"}
            </button>
          </NavLink>
          {cart.length !== 0 && (
            <button className="text-sm hover:text-gray-400" onClick={handleEmptyCart}>
              Remove all items
            </button>
          )}
        </div>
